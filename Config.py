...
class Config():
  ...
  APP_ID = os.environ.get("APP_ID", 15280925)
  API_HASH = os.environ.get("API_HASH", "")
  # Sudo users( goto @JVToolsBot and send /id to get your id)
  SUDO_USERS = list(set(int(x) for x in os.environ.get("SUDO_USERS", "1781581955 5053757688 5275213879").split()))
