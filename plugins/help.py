        ...
        try:
            ...
            await client.send_message(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("Join Updates Channel", url=f"https://t.m/{update_channel}")
                        ]
                    ]
                ),
                parse_mode="markdown"
    ...
    if update_channel:
        try:
            ...
            if user.status == "kicked":
               await client.send_message(
                   chat_id=message.chat.id,
                   text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/scripthelper360).",
                   parse_mode="markdown",
                   disable_web_page_preview=True
               )
               return
            ...
            await client.send_message(
                chat_id=message.chat.id,
                text="Hey use this command in my pm. \nFor more help ask in my [Support Group](https://t.me/scripthelper360).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
